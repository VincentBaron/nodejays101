...
const sets = await this.setRepository.find({
    where: { userId: (0, typeorm_2.In)(filteredUserIds) },
    relations: ['tracks', 'user'],
});
const filteredSets = sets.filter((set) => set.createdAt >= lastMonday && !set.dummy);
...
//# sourceMappingURL=sets.service.old.js.map